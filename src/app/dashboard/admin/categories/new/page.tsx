...
const CategoryFormInner = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // FormData ব্যবহার করে ডাটা পাঠানো হচ্ছে
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 space-y-6">
                    <div className="bg-white p-6 rounded-md border border-gray-200 shadow-sm space-y-5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div className="space-y-2">
                                <label className="text-sm font-semibold text-gray-700">Category Name *</label>
                                <input type="text" name="name" required className="w-full px-4 py-2.5 border border-gray-200 rounded-md outline-none focus:border-[#5CAF90] text-sm" value={formData.name} onChange={handleChange} />
                            </div>
                            <div className="space-y-2">
                                <label className="text-sm font-semibold text-gray-700">Slug (URL Key)</label>
                                <input type="text" name="slug" className="w-full px-4 py-2.5 border border-gray-200 rounded-md outline-none focus:border-[#5CAF90] text-sm" value={formData.slug} onChange={handleChange} />
                            </div>
                        </div>
                        <div className="space-y-2">
                            <label className="text-sm font-semibold text-gray-700">Parent Category</label>
                            <select name="parentCategory" className="w-full px-4 py-2.5 border border-gray-200 rounded-md outline-none focus:border-[#5CAF90] text-sm" value={formData.parentCategory} onChange={handleChange}>
                                <option value="">Root Category (None)</option>
                                {categories.map((cat: any) => (
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-semibold text-gray-700">Description</label>
                            <textarea name="description" rows={4} className="w-full px-4 py-2.5 border border-gray-200 rounded-md outline-none focus:border-[#5CAF90] text-sm" value={formData.description} onChange={handleChange}></textarea>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-md border border-gray-200 shadow-sm space-y-5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div className="space-y-2">
                                <label className="text-sm font-semibold text-gray-700">Meta Title</label>
                                <input type="text" name="metaTitle" className="w-full px-4 py-2.5 border border-gray-200 rounded-md outline-none focus:border-[#5CAF90] text-sm" value={formData.metaTitle} onChange={handleChange} />
                            </div>
                            <div className="space-y-2">
                                <label className="text-sm font-semibold text-gray-700">Display Order</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-semibold text-gray-700">Meta Description</label>
                            <textarea name="metaDescription" rows={3} className="w-full px-4 py-2.5 border border-gray-200 rounded-md outline-none focus:border-[#5CAF90] text-sm" value={formData.metaDescription} onChange={handleChange}></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    <div className="bg-white p-6 rounded-md border border-gray-200 shadow-sm space-y-5">
                        ...
                        <div className="space-y-4">
                            <div className="space-y-2">
                                ...
                                {formData.image && (
                                    <div className="mt-2 w-full aspect-square bg-gray-50 rounded-md overflow-hidden border border-gray-200 relative">
                                        <img src={typeof formData.image === 'string' ? formData.image : URL.createObjectURL(formData.image as File)} alt="Preview" className="w-full h-full object-cover" />
                                        <button type="button" onClick={() => setFormData(prev => ({ ...prev, image: null }))} className="absolute top-2 right-2 p-1.5 bg-red-500 text-white rounded-md"><FiX size={14} /></button>
                                    </div>
                                )}
                            </div>
                            <div className="space-y-2">
                                <label className="text-sm font-semibold text-gray-700">Icon URL</label>
                                <input type="text" name="icon" className="w-full px-4 py-2.5 border border-gray-200 rounded-md outline-none focus:border-[#5CAF90] text-sm" value={formData.icon} onChange={handleChange} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-md border border-gray-200 shadow-sm space-y-5">
                        ...
                        <div className="space-y-4 pt-2">
                            <label className="flex items-center gap-3 cursor-pointer"><input type="checkbox" name="isFeatured" checked={formData.isFeatured} onChange={handleChange} /> Featured Category</label>
                            <label className="flex items-center gap-3 cursor-pointer"><input type="checkbox" name="showInMenu" checked={formData.showInMenu} onChange={handleChange} /> Show in Menu</label>
                            <label className="flex items-center gap-3 cursor-pointer"><input type="checkbox" name="showInHome" checked={formData.showInHome} onChange={handleChange} /> Show on Homepage</label>
                        </div>
                    </div>
                </div>
            </form>
...
const CategoryForm = () => {
    return (
        <Suspense fallback={<div className="p-20 text-center text-[#5CAF90]">Initializing...</div>}>
            <CategoryFormInner />
        </Suspense>
    );
};
