...
//                     <h3 className="font-bold text-gray-800 text-lg">Reply to Complaint</h3>
...
//                         <p className="text-xs font-bold text-red-600 uppercase mb-1">Complainant's Message</p>
//                         <p className="text-sm text-red-900 italic">"{complaint?.text}"</p>
//                     </div>
//                     <div>
...
//         try {
//             await updateComplaint({ id, status }).unwrap();
...
//         { label: 'Pending', value: statusCounts.pending || 0, icon: FiClock, color: 'text-amber-600', bg: 'bg-amber-50', border: 'border-amber-100' },
//         { label: 'Resolved', value: statusCounts.resolved || 0, icon: FiCheckCircle, color: 'text-emerald-600', bg: 'bg-emerald-50', border: 'border-emerald-100' },
//         { label: 'Rejected', value: statusCounts.rejected || 0, icon: FiXCircle, color: 'text-red-600', bg: 'bg-red-50', border: 'border-red-100' },
//     ];
...
//                                                         <FiCornerDownRight className="text-gray-400 flex-shrink-0 mt-0.5" size={16} />
