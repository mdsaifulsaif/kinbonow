    ...
    return (
        <div className='container mx-auto px-4 sm:px-8 md:px-12 lg:px-16'>
            <div className='flex gap-0 leading-none'>
                ...
                <div className='flex-1 lg:pl-8 py-8 bg-[url("/banner/slider1.jpg")] bg-cover bg-center bg-no-repeat'>
                    <div
                        className='h-[510px]  rounded-2xl overflow-hidden relative group'
                    >
                        ...
                        <div className='relative z-10 h-full flex flex-col md:flex-row items-center'>
                            ...
                            <div className='flex-1 flex flex-col justify-center px-8 md:px-16 text-center md:text-left'>
                                ...
                                <h1 className='text-4xl md:text-5xl lg:text-[40px] font-black text-gray-900 mb-2 leading-tight uppercase'>
                                    Daily Essentials Delivered <br /> to Your Door
                                </h1>
